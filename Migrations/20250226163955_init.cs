        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockImage = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsPublishedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StockID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvestmentPrice = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1d4f656b-32fd-4c94-91dc-4f5b9d1eb1c7", null, "Admin", "ADMIN" },
                    { "2a94cbbb-1f3a-4d77-913b-fc208a173546", null, "User", "USER" }
                });
